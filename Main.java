/* 
Here is my first program! It's a mortgage calculator. Just so you understand the math, here's the calculations: P * [((r+1)^m) / ((r+1)^m -1)] 
--------------------------------------------------------------------------
P = Principal, 
...
class Main {
  public static void main(String[] args) {
    ...
    //STEP 1: Ask for the prinicipal first
    System.out.println("Hey there! What's the principal on your mortgage in USD?");
    ...
    /* Now let's figure out how many months it will take to pay it off,
       multiply by 12 to get the months */
    ...
    System.out.println("Your monthly debt is: " + finalStep + "per month!");
    
  }
}
//There you have it! I did it on my own and it works pretty well!
